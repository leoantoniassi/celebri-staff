...
## Aplicativo Móvel: Celebri Staff — Plataforma SaaS White Label de Gestão de Eventos e Buffets
...
| :---: | :---: | :--- | :--- |
| 26/08/2026 | 1.0 | Elaboração inicial do documento do Plano de Projeto Ágil de Software para o App Mobile (Celebri Staff), incluindo Canvas de Negócio, Arquitetura Híbrida, Backlog de Histórias de Usuário, Cronograma de 6 Sprints, DoR/DoD e Matriz de Riscos. | Luis Felipe Veronezi (PO), Leonardo Antoniassi (Dev), Bruno Righi (UX/QA) |
...
Este documento formaliza a iniciação do projeto ágil de software para o desenvolvimento da extensão móvel (**Celebri Staff**), referente ao Projeto Integrador do 5º semestre do curso de Desenvolvimento de Software Multiplataforma. O projeto consiste na evolução e pivotagem da plataforma web de gestão de eventos para um modelo **SaaS B2B Multilocatário (White Label)** denominado **Celebri**.
...
#### Canvas do Modelo de Negócio (Celebri SaaS B2B)
...
O aplicativo móvel **Celebri Staff** não é um aplicativo isolado; ele é uma peça fundamental do ecossistema integrado Celebri:
...
|                                                                       |
|  +------------------------+             +--------------------------+  |
|  |       Painel Web       |             | App Mobile Celebri Staff |  |
...
* **App Mobile (Celebri Staff):** Consome a API central para estender as funcionalidades para o dia do evento no salão de festas, provendo portaria com QR Code, escalas de trabalho, cronograma vivo e chamadas via WhatsApp.
...
* **Repositório do Aplicativo Móvel (Celebri Staff):** [https://github.com/leoantoniassi/celebri-staff](https://github.com/leoantoniassi/celebri-staff)
* **Repositório da Plataforma Web / API Central (Celebri Core):** [https://github.com/leoantoniassi/celebri](https://github.com/leoantoniassi/celebri)
...
```mermaid
graph TD
    subgraph Dispositivo Movel [App Mobile Celebri Staff]
...
Neste projeto do 5º semestre, será desenvolvido o aplicativo móvel **Celebri Staff** contendo os 5 pilares operacionais selecionados:
